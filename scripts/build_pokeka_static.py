...
- 見出し「ポケカ買取表」1.2倍 / ロゴとアクション群は中央寄せ
...
DEFAULT_EXCEL = str(Path(__file__).resolve().parent.parent / "data" / "pokeca_rush.xlsm")
...
# よく使う固定ディレクトリ（探索用）
FIXED_DIRS = [
    Path(r"C:\Users\user\OneDrive\Desktop\ポケカ買取表"),
    Path(r"C:\Users\user\OneDrive\Desktop\ポケカ買取表"),
    Path.cwd(),
...
write_mode("default", "'desc'", "ポケカ買取表")
write_mode("price_desc", "'desc'", "ポケカ買取表（price_desc）")
write_mode("price_asc",  "'asc'",  "ポケカ買取表（price_asc）")
